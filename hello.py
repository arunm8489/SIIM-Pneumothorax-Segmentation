...
if uploaded_image is not None:
                # To See details
        with open(os.path.join("tmp",uploaded_image.name),"wb") as f: 
            f.write(uploaded_image.getbuffer())

        st.image(load_image(os.path.join("tmp",uploaded_image.name)),width=250)
        ...
        #st.image(load_image(image_file_path),width=250)
